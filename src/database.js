...
function createNonMemberInvitation(input){
    ...
    let statement = `INSERT INTO NonMemberInvitations (invitationId, meetingId, attendantEmail, acceptedDatesAndTimes) ` +
        `VALUES ('${input.invitationId}', '${input.meetingId}', '${input.attendantEmail}', '${input.acceptedDatesAndTimes}')`;

    return sqlite3_wrapper.runPromisified(statement, 'INSERT INTO NonMemberInvitations');
}
...
function getAllNonMemberInvitations(){
    let statement = `SELECT invitationId, meetingId, attendantEmail, acceptedDatesAndTimes FROM NonMemberInvitations`;
    return sqlite3_wrapper.allPromisified(statement, 'SELECT FROM NonMemberInvitations');
}
...
function deleteAllNonMemberInvitations(){
    let statement = `DELETE FROM NonMemberInvitations`;
...
function getNonMemberInvitationById(id){
    ...
    let statement = `SELECT invitationId, meetingId, attendantEmail, acceptedDatesAndTimes FROM NonMemberInvitations WHERE invitationId='${id}'`;

    return sqlite3_wrapper.getPromisified(statement, 'SELECT FROM NonMemberInvitations');
}
...
function deleteNonMemberInvitation(id){
    let statement = `DELETE FROM NonMemberInvitations WHERE invitationId='${id}'`;
    return sqlite3_wrapper.runPromisified(statement, 'DELETE FROM NonMemberInvitations');
}
...
function updateNonMemberInvitation(input){
    ...
    let statement = `UPDATE NonMemberInvitations SET ${fields.join(', ')} WHERE invitationId='${input.invitationId}'`;
    return sqlite3_wrapper.runPromisified(statement, 'UPDATE NonMemberInvitations');
}
